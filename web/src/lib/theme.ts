...
export function readAppearance(): Appearance {
  const saved = localStorage.getItem("mchact_appearance");
  return saved === "light" ? "light" : "dark";
}

export function saveAppearance(value: Appearance): void {
  localStorage.setItem("mchact_appearance", value);
}

export function readUiTheme(): UiTheme {
  const saved = localStorage.getItem("mchact_ui_theme") as UiTheme | null;
...
export function saveUiTheme(value: UiTheme): void {
  localStorage.setItem("mchact_ui_theme", value);
}
